({
    ...
    processTabOpen: function(component, event, helper) {
        ...
        console.log('processTabOpen: targetPage extracted ',JSON.stringify(targetPage));
        ...
        if (isConsole) {
        	...
        	console.log('processTabOpen: topening target tab');
        }
        else {
            // ### STANDARD MODE ###
    ...
    processTabFocus : function(component, event, helper) {
        ...
        if (helper.TABS_TO_FOCUS[previousTabId]) {
        	console.log('processTabFocus: previousTab TS ', helper.TABS_TO_FOCUS[previousTabId]);
            let currentTS = Date.now();
        	console.log('processTabFocus: current TS ', currentTS);
            ...
            if (currentTS - helper.TABS_TO_FOCUS[previousTabId] > 1000) {
                console.log('processTabFocus: END / ignoring user tab selection');
        	...
        	console.log('processTabFocus: no previousTab to refocus ',previousTabId);
        }
